...
$CONFIG=array(
	'debug'=>1,
	'site'=>'cms.azbn.ru',
	'base_url'=>'http://ohm.dorohovdesign.ru/',
	'charset'=>'UTF-8',
	...
	'sys_path'=>'include',
	'app_path'=>'apps',
	'phpmorphy_path'=>'phpmorphy/0.3.7/',
	'backup_path'=>'backup',
	'plugin_path'=>'plugin',
	...
	'mysql_user'=>'ohm_dorohov',
	'mysql_pass'=>'ohm_dorohov',
	'mysql_base'=>'ohm_dorohov',
	...
	'mysql_tables'=>array(
		...
		't_product_option'=>$prefix.'_product_option',
		...
		't_region'=>$prefix.'_region',
		
		'hagent'=>'ohm_hagent',
		'i_plen'=>'ohm_i_plen',
		
		'i_vozd'=>'ohm_i_vozd',
		'i_vozd_k'=>'ohm_i_vozd_k',
